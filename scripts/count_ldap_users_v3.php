...
do {
    ...
    $errcode = $matcheddn = $errmsg = '';
    $referrals = $ret_controls = [];
    ldap_parse_result($ldap, $res, $errcode, $matcheddn, $errmsg, $referrals, $ret_controls);
    
    $cookie = '';
    if (isset($ret_controls[LDAP_CONTROL_PAGEDRESULTS]['value']['cookie'])) {
